...
let s:bwc.dalespale         = ['fade3e', 221] " A color sampled from a highlight in a photo of a glass of Dale's Pale Ale on my desk.
let s:bwc.dirtyblonde       = ['f4cf86', 222] " A beautiful tan from Tomorrow Night.
let s:bwc.taffy             = ['ff2c4b', 196] " Delicious, chewy red from Made of Code for the poppiest highlights.
let s:bwc.saltwatertaffy    = ['8cffba', 121] " Another chewy accent, but use sparingly!
let s:bwc.tardis            = ['0a9dff', 39] " * A REPL prompt
let s:bwc.orange            = ['ffa724', 214] " This one's from Mustang, not Florida!
let s:bwc.lime              = ['aeee00', 154] " A limier green from Getafe.
let s:bwc.dress             = ['ff9eb8', 211] " Rose's dress in The Idiot's Lantern.
let s:bwc.toffee            = ['b88853', 137] " Another play on the brown from Clouds Midnight.  I love that color.
