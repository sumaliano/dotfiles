...
" public {{{
    " function! suma#set_highlight(group, style)
    "   call s:h(a:group, a:style)
    " endfunction

    " function! suma#extend_highlight(group, style)
...
let s:overrides = get(g:, "suma_color_overrides", {})
...
call s:h("Debug",            { "fg": s:white, "gui": "bold", "cterm": "bold" })
...
call s:h("DiffAdd", { "bg": s:special_grey }) " diff mode: Added line
call s:h("DiffChange", { "bg": s:black }) " diff mode: Changed line
call s:h("DiffDelete", { "bg": s:special_grey, "fg": s:special_grey }) " diff mode: Deleted line
call s:h("DiffText", { "bg": s:blue, "fg": s:black }) " diff mode: Changed text within a changed line
call s:h("Error", {  "bg": s:red, "fg": s:black }) " error messages on the command line
