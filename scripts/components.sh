...
ALL_CONFIGS=(bash vim nvim tmux git hypr utils fonts inputrc joshuto yazi lazygit aerc)
...
ALL_CONFIGS_REMOTE=(bash git inputrc nvim vim tmux joshuto yazi lazygit aerc)
